...
import {
  Building2, Plug, Sparkles, CalendarDays,
  HelpCircle, ChevronDown, Terminal, BookOpen, Keyboard, Info,
} from 'lucide-react';
        ...
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="text-sm font-semibold tracking-tight hidden sm:block">
              VSHAD <span className="text-muted-foreground font-normal">RoboSocial</span>
            </span>
          </Link>
